...
- [Um pouco de protocolo HTTP](https://www.vivaolinux.com.br/artigo/Um-pouco-do-protocolo-HTTP?pagina=1)
- [Introduction to Distributed System Design](http://www.hpcs.cs.tsukuba.ac.jp/~tatebe/lecture/h23/dsys/dsd-tutorial.html)
- [Best Practices for SOAP and REST API](https://www.imperva.com/learn/application-security/web-api-security/)
...
- [What is XSS | Stored Cross Site Scripting Example](https://www.imperva.com/learn/application-security/cross-site-scripting-xss-attacks/)
- [How to Adjust TCP Window Size to Improve Network Performance](https://www.auvik.com/franklymsp/blog/tcp-window-size/)
- [Backend Skills](https://medium.com/@mobilunity/what-skills-do-i-need-to-become-back-end-web-developer-8cdd16fad6c8)